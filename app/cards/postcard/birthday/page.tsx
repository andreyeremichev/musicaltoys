...
/* -------------------- Background presets -------------------- */
type LayoutId = "01" | "02" | "03" | "04" | "05" | "06" | "07" | "08" | "09" | "10";

type Motion = "glow" | "pulse";
type DemoStyle = "fireworks" | "reveal";

// Birthday atmosphere choices (intro layer, user can toggle off)
...
const LAYOUTS: Record<
  LayoutId,
  {
    ...
    // ✅ Atmosphere (Birthday: ON by default)
    defaultAtmosphereOn: boolean;
    defaultAtmospherePreset: AtmospherePreset;
...
> = {
  "01": {
    label: "Sprinkles",
    src: "/cards/postcards/birthday/01.jpg",
    wishFont: "hand",
    disableBackdrop: true,
    defaults: { textInk: "warmWhite", trailA: "rose", trailB: "sky" },
    defaultMotion: "pulse",
  ...
  "02": {
    label: "Candle Glow",
    src: "/cards/postcards/birthday/02.jpg",
    wishFont: "vintage",
    disableBackdrop: true,
    defaults: { textInk: "warmWhite", trailA: "antiqueGold", trailB: "antiqueGold" },
    defaultMotion: "glow",
  ...
  "03": {
    label: "Confetti",
    src: "/cards/postcards/birthday/03.jpg",
    wishFont: "hand",
    disableBackdrop: true,
  ...
  "04": {
    label: "Blue Candle",
    src: "/cards/postcards/birthday/04.jpg",
    wishFont: "vintage",
    disableBackdrop: true,
    defaults: { textInk: "ink", trailA: "sky", trailB: "frost" },
    defaultMotion: "glow",
    defaultMood: "brighter",
    defaultZeroPolicy: "chromatic",
    defaultAtmosphereOn: true,
  ...
  "05": {
    label: "Sparkler",
    src: "/cards/postcards/birthday/05.jpg",
    wishFont: "hand",
    disableBackdrop: true,
  ...
  "06": {
    label: "Baby Blocks",
    src: "/cards/postcards/birthday/06.jpg",
    wishFont: "hand",
    disableBackdrop: true,
    defaults: { textInk: "ink", trailA: "emerald", trailB: "sky" },
    defaultMotion: "glow",
    defaultMood: "balanced",
    defaultZeroPolicy: "chromatic",
    defaultAtmosphereOn: true,
  ...
  "07": {
    label: "Party Prep",
    src: "/cards/postcards/birthday/07.jpg",
    wishFont: "hand",
    disableBackdrop: true,
  ...
  "08": {
    label: "Paper Rolls",
    src: "/cards/postcards/birthday/08.jpg",
    wishFont: "vintage",
    disableBackdrop: true,
    defaults: { textInk: "ink", trailA: "sky", trailB: "gold" },
    defaultMotion: "glow",
    defaultMood: "brighter",
    defaultZeroPolicy: "chromatic",
    defaultAtmosphereOn: true,
  ...
  "09": {
    label: "Pet Treat",
    src: "/cards/postcards/birthday/09.jpg",
    wishFont: "hand",
    disableBackdrop: true,
    defaults: { textInk: "ink", trailA: "frost", trailB: "emerald" },
    defaultMotion: "pulse",
    defaultMood: "balanced",
    defaultZeroPolicy: "chromatic",
    defaultAtmosphereOn: true,
  ...
  "10": {
    label: "Party Hat",
    src: "/cards/postcards/birthday/10.jpg",
    wishFont: "hand",
    disableBackdrop: true,
    defaults: { textInk: "snowWhite", trailA: "rose", trailB: "gold" },
    defaultMotion: "pulse",
    defaultMood: "balanced",
    defaultZeroPolicy: "chromatic",
    defaultAtmosphereOn: true,
...
export default function XmasPostcardPage() {
  ...
  const [typed, setTyped] = useState("00B -");
...
const [demoRevealOn, setDemoRevealOn] = useState(false);
  ...
  // Atmosphere (Birthday intro sound)
...
for (let segIdx = 0; segIdx < segCount; segIdx++) {
  ...
  // Birthday-style atmosphere: play once at the very start (only first segment)
...
if (showPulseOnly && mainStarted && fw.length === 0 && globalStep >= 0) {
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "@type": "WebApplication",
      name: "Birthday Musical Postcard",
      applicationCategory: "MusicApplication",
      operatingSystem: "Web",
      url: "https://musicaltoys.app/cards/postcard/birthday",
      description:
        "Create a ‘birthday’ musical postcard from a meaningful date or message. Choose a background, play it, and share a link that recreates the same postcard.",
...
<div style={{ display: "grid", gap: 8 }}>
  ...
  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
    <button
      ...
      title="Extra birthday intro sound"
    >
      On
    </button>
    <button

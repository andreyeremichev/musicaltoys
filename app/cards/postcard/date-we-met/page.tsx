...
> = {
  // 01 – minimal heart line
  "01": {
    label: "Simple Heart",
    src: "/cards/postcards/date-we-met/01.jpg",
    wishFont: "hand",
  ...
  // 02 – classic card with ribbon
  "02": {
    label: "Classic Card",
    src: "/cards/postcards/date-we-met/02.jpg",
    wishFont: "vintage",
    disableBackdrop: true,
  ...
  // 03 – two profiles, cool blue
  "03": {
    label: "Two Profiles",
    src: "/cards/postcards/date-we-met/03.jpg",
    wishFont: "vintage",
    disableBackdrop: true,
    defaults: { textInk: "warmWhite", trailA: "sky", trailB: "gold" },
    defaultMotion: "glow",
    defaultMood: "balanced",
  ...
  // 04 – sunset couple silhouette
  "04": {
    label: "Sunset",
    src: "/cards/postcards/date-we-met/04.jpg",
    wishFont: "hand",
    disableBackdrop: true,
  ...
  // 05 – vintage silhouettes in frame
  "05": {
    label: "Framed Memory",
    src: "/cards/postcards/date-we-met/05.jpg",
    wishFont: "vintage",
    disableBackdrop: true,
    defaults: { textInk: "cocoa", trailA: "antiqueGold", trailB: "gold" },
    defaultMotion: "glow",
  ...
  // 06 – warm geometric couple frame
  "06": {
    label: "Warm Frame",
    src: "/cards/postcards/date-we-met/06.jpg",
    wishFont: "hand",
    disableBackdrop: true,
    defaults: { textInk: "warmWhite", trailA: "rose", trailB: "gold" },
    defaultMotion: "glow",
    defaultMood: "brighter",
    defaultZeroPolicy: "ticks",
    demo: { style: "reveal" },
  ...
  // 07 – map lines with heart
  "07": {
    label: "Where It Began",
    src: "/cards/postcards/date-we-met/07.jpg",
    wishFont: "hand",
    disableBackdrop: true,
    defaults: { textInk: "cocoa", trailA: "emerald", trailB: "gold" },
    defaultMotion: "glow",
    defaultMood: "balanced",
    defaultZeroPolicy: "ticks",
    demo: { style: "reveal" },
  ...
  // 08 – concentric circle / record
  "08": {
    label: "Our Orbit",
    src: "/cards/postcards/date-we-met/08.jpg",
    wishFont: "vintage",
    disableBackdrop: true,
    defaults: { textInk: "cocoa", trailA: "antiqueGold", trailB: "rose" },
    defaultMotion: "glow",
    defaultMood: "darker",
    defaultZeroPolicy: "rest",
    demo: { style: "reveal" },
  ...
  // 09 – very minimal circular design
  "09": {
    label: "Quiet Moment",
    src: "/cards/postcards/date-we-met/09.jpg",
    wishFont: "hand",
    disableBackdrop: true,
    defaults: { textInk: "cocoa", trailA: "gold", trailB: "warmWhite" },
    defaultMotion: "glow",
    defaultMood: "darker",
    defaultZeroPolicy: "ticks",
    demo: { style: "reveal" },
...
export default function XmasPostcardPage() {
  ...
  const [typed, setTyped] = useState("Feb 14");
...
scheduleChromaLive(ac, at, tok, keyNow);
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      description:
        "Create a ‘date we met’ musical postcard from a meaningful date or message. Choose a background, play it, and share a link that recreates the same postcard.",

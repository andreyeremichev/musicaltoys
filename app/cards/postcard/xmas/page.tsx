...
> = {
  ...
  "04": {
    ...
    wishFont: "festive",
    disableBackdrop: true,
    defaults: { textInk: "sky", trailA: "snowWhite", trailB: "gold" },
    defaultMotion: "pulse",
    defaultMood: "brighter",
    defaultZeroPolicy: "chromatic",
...
/* -------------------- Wishes -------------------- */
const WISHES = [
  "Warm lights. Soft wishes.",
  "Merry Christmas.",
  "A little magic, right here.",
  "Let it glow.",
  "Wrapped with love.",
  "Make a wish.",
...
export default function XmasPostcardPage() {
  ...
  const [typed, setTyped] = useState("MERRY XMAS 2U");
...
function runMicroDemo() {
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      description:
        "Create a Christmas musical postcard from any date or message. Choose a background, play it, and share a link that recreates the same postcard.",
